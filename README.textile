...
h3. Compile test.coffee into test.js
compiler.Compile("test.coffee");

h3. Compiles coffeescript string into a javascript string
var javascriptString = compiler.CompileString("helloworld -> 'hello world'")

h3. Inside a .coffee file : includes desired .coffee file
@require file.coffee

h3. Example custom pre/post compilation
